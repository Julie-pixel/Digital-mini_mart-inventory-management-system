...
if (isset($_POST['add_supplier'])) {
    ...
    if (empty($name) || empty($contact)) {
        ...
        $query = "INSERT INTO suppliers (supplier_name, contact_number, email) 
...
<head>
    ...
    <title>Add New Supplier | Digital Mini-Mart</title>
...
<div class="main-content">
    <div class="form-card">
        ...
        <p class="subtitle">Enter supplier details below</p>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" name="supplier_name" placeholder="e.g. Fresh Farms Ltd" required 
                       value="<?= isset($_POST['supplier_name']) ? htmlspecialchars($_POST['supplier_name']) : '' ?>">
            </div>

            <div class="form-group">
                <label class="required">Contact Number</label>
                <input type="text" name="contact_number" placeholder="e.g. +254 712 345 678" required
